...
#	return scene is Map ## coś się zjebawszy
	return scene.name == "Map"
...
func _get_game_scene(for_scene: Node) -> String:
	return "res://Tools/GameRunner.tscn"
...
static func is_custom_running() -> bool:
	return not OS.get_environment("__run_data__").is_empty()
...
static func get_variable(variable: String):
	...
	var data: Dictionary = str_to_var(OS.get_environment("__run_data__"))
